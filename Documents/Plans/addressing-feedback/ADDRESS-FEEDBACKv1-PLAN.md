 ...
 - A dropdown Picker (menu style) bound to viewModel.maxDataMb, with integer options
 1...500 MB (labelled e.g. "10 MB"), default 10. No free-text entry — this removes
 the need for digit validation/clamping entirely.
 ...
 Verify: build; open Settings — only Units + Data Limit remain; the limit is a 1–500 MB
 dropdown defaulting to 10 and persists across app relaunch; grep -ri bodyweight Sources/
